...
def parse_ucf101_splits(level):
    ...
    """
    class_index_file = '/data0/zhangguozhen/ucf101/annotations/classInd.txt'
    train_file_template = '/data0/zhangguozhen/ucf101/annotations/trainlist{:02d}.txt'
    test_file_template = '/data0/zhangguozhen/ucf101/annotations/testlist{:02d}.txt'
